...
class TestClienteCRUD(unittest.TestCase):
    ...
    def test_cedula_existente(self):
        cliente_crud.registrar_cliente("Laura", "111")
        cliente = cliente_crud.buscar_cliente_por_cedula("111")
        self.assertIsNotNone(cliente)
        self.assertEqual(cliente.nombre, "Laura")

    def test_buscar_por_cedula(self):
        with self.assertRaises(ValueError):
            cliente_crud.buscar_por_cedula("1110")
